...
const objProx = new Proxy(StandardModule, {
  get(obj, prop) {
    ...
    if (prop === "View") {
      return new Proxy(obj[prop], {
        get(obj, prop) {
          if (prop === "propTypes") return deprecatedProps.ViewPropTypes;
          return Reflect.get(...arguments);
        },
      });
    }
    if (prop === "Color") {
      return new Proxy(obj[prop], {
        get(obj, prop) {
          if (prop === "propTypes") return deprecatedProps.ColorPropType;
          return Reflect.get(...arguments);
        },
      });
    }
    if (prop === "EdgeInsets") {
      return new Proxy(obj[prop], {
        get(obj, prop) {
          if (prop === "propTypes") return deprecatedProps.EdgeInsetsPropType;
          return Reflect.get(...arguments);
        },
      });
    }
    if (prop === "Point") {
      return new Proxy(obj[prop], {
        get(obj, prop) {
          if (prop === "propTypes") return deprecatedProps.PointPropType;
          return Reflect.get(...arguments);
        },
      });
    }
